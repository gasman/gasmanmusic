...
var AudioPlayer = (function() {
    ...
    '          <i class="material-icons md-light">skip_previous</i>'+
    '        </button>'+
    '        <button class="ap-controls ap-toggle-btn">'+
    '            <i class="material-icons md-light ap--play">play_arrow</i>'+
    '            <i class="material-icons md-light ap--pause">pause</i>'+
    '        </button>'+
    '        <button class="ap-controls ap-next-btn">'+
    '          <i class="material-icons md-light">skip_next</i>'+
    '        </button>'+
    '      </div>'+
    ...
    '              <i class="material-icons md-light ap--volume-on">volume_up</i>'+
    '              <i class="material-icons md-light ap--volume-off">volume_mute</i>'+
    '          </button>'+
    '          <div class="ap-volume">'+
    ...
    '          <i class="material-icons md-light">repeat</i>'+
    '        </button>'+
